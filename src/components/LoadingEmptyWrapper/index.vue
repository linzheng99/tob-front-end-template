<template>
  <div class="relative min-h-200px">
    ...
    <div
      ...
      class="absolute left-0 top-0 wh-full border-base bg-base border-1px"
    ...
    >
      ...
      <div v-show="isEmpty" :class="absolute_center">
        <div class="relative w-full">
          <p class="absolute left-0 bottom-0 text-16px c-base w-full text-center">
            {{ emptyTitle }}
          </p>
        </div>
      </div>
...
const placeholderClass = 'transition-background-color duration-300 ease-in-out'
